...
/**
 * print_list_str - Prints only the 'str' element of a signed int(list_t) linked list.
...
/**
 * delete_node_at_index - Removes a node at the given index.
...
/**
 * free_list - Re;eases all linked list nodes.
